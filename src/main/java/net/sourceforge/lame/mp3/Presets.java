...
public class Presets {
	...
	private static final ABRPresets abr_switch_map[] = {
			new ABRPresets(9, 9, 0, 0f, 6.60f, 145f, 0f, 0.95f, 0f, -30.0f, 11f, 0.0012f, 1), /*   8, impossible to use in stereo */
			new ABRPresets(9, 9, 0, 0f, 6.60f, 145f, 0f, 0.95f, 0f, -25.0f, 11f, 0.0010f, 1), /*  16 */
			new ABRPresets(9, 9, 0, 0f, 6.60f, 145f, 0f, 0.95f, 0f, -20.0f, 11f, 0.0010f, 1), /*  24 */
			new ABRPresets(9, 9, 0, 0f, 6.60f, 145f, 0f, 0.95f, 0f, -15.0f, 11f, 0.0010f, 1), /*  32 */
			new ABRPresets(9, 9, 0, 0f, 6.60f, 145f, 0f, 0.95f, 0f, -10.0f, 11f, 0.0009f, 1), /*  40 */
			new ABRPresets(9, 9, 0, 0f, 6.60f, 145f, 0f, 0.95f, 0f, -10.0f, 11f, 0.0009f, 1), /*  48 */
			new ABRPresets(9, 9, 0, 0f, 6.60f, 145f, 0f, 0.95f, 0f, -6.0f, 11f, 0.0008f, 1), /*  56 */
			new ABRPresets(9, 9, 0, 0f, 6.60f, 145f, 0f, 0.95f, 0f, -2.0f, 11f, 0.0008f, 1), /*  64 */
			new ABRPresets(9, 9, 0, 0f, 6.60f, 145f, 0f, 0.95f, 0f, .0f, 8f, 0.0007f, 1), /*  80 */
			new ABRPresets(9, 9, 0, 2.50f, 6.60f, 145f, 0f, 0.95f, 0f, 1.0f, 5.5f, 0.0006f, 1), /*  96 */
			new ABRPresets(9, 9, 0, 2.25f, 6.60f, 145f, 0f, 0.95f, 0f, 2.0f, 4.5f, 0.0005f, 1), /* 112 */
			new ABRPresets(9, 9, 0, 1.95f, 6.40f, 140f, 0f, 0.95f, 0f, 3.0f, 4f, 0.0002f, 1), /* 128 */
			new ABRPresets(9, 9, 1, 1.79f, 6.00f, 135f, 0f, 0.95f, -2f, 5.0f, 3.5f, 0f, 1), /* 160 */
			new ABRPresets(9, 9, 1, 1.49f, 5.60f, 125f, 0f, 0.97f, -4f, 7.0f, 3f, 0f, 0), /* 192 */
			new ABRPresets(9, 9, 1, 1.25f, 5.20f, 125f, 0f, 0.98f, -6f, 9.0f, 2f, 0f, 0), /* 224 */
			new ABRPresets(9, 9, 1, 0.97f, 5.20f, 125f, 0f, 1.00f, -8f, 10.0f, 1f, 0f, 0), /* 256 */
			new ABRPresets(9, 9, 1, 0.90f, 5.20f, 125f, 0f, 1.00f, -10f, 12.0f, 0f, 0f, 0) /* 320 */
	};
	Lame lame;
	...
	private void apply_vbr_preset(final LameGlobalFlags gfp, final int a, final int enforce) {
		final VBRPresets[] vbr_preset = gfp.getVBR() == VbrMode.vbr_rh ? vbr_old_switch_map : vbr_psy_switch_map;
	...
	private int apply_abr_preset(final LameGlobalFlags gfp, final int preset, final int enforce) {
	...
	public final int apply_preset(final LameGlobalFlags gfp, int preset, final int enforce) {
