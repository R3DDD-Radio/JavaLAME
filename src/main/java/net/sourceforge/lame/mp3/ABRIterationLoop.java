 ...
 * @author Ken
 */
public final class ABRIterationLoop implements IterationLoop {
	...
	@Override
	public final void iterationLoop(final LameGlobalFlags gfp, final float pe[][], final float ms_ener_ratio[], final III_psy_ratio ratio[][]) {
